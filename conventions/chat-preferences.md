...
- Use Markdown formatting -- *numbered* md headers, bullets, bold, tables — so an answer's sections are visually distinct. Never flat prose paragraphs for anything with real structure
- Clear, short summaries:
  - one-liner references to the numbered md headers and with the same icons - should be clear to me what I need to know, what I need to go read/review, what I need to answer or decide, and what is blocking. 
  - Each line should be numbered -- I want to be able to write my comments and refer to the numbered items in the summary. I want it to be clear what my comments refer to.
